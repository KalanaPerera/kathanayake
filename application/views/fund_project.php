                    ...
                    <div class="panel-heading" style="background:  #869694 !important">
                        <div class="media">
                            <a href="" class="pull-left">
                                <img src="/kathanayake/dist/images/logo-square_50.png" class="media-object">
                            </a>
...
<!--                                <div class="media-body">
                            ...
                            <ul class="icon-list">
                                <li><i class="fa fa-star fa-fw"></i>  Thank You </li>
                            </ul>
                        </div>
                    </div>
                    <div class="view-all-comments"><a href="#"><i class="fa fa-comments-o"></i> View all</a> 10 comments</div>
